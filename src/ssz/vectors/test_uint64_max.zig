...
// tests/fillers/ssz/test_basic_types.py::test_uint64_max[ssz_test]
// typeName: Uint64

test "vectors.test_uint64_max" {
    const allocator = testing.allocator;
    const value: u64 = @as(u64, 18446744073709551615);

    const expected_serialized_hex = "ffffffffffffffff";
    ...
    const expected_root_hex = "ffffffffffffffff000000000000000000000000000000000000000000000000";
