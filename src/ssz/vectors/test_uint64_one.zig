...
// tests/fillers/ssz/test_basic_types.py::test_uint64_one[ssz_test]
// typeName: Uint64

test "vectors.test_uint64_one" {
    const allocator = testing.allocator;
    const value: u64 = @as(u64, 1);

    const expected_serialized_hex = "0100000000000000";
