...
// tests/fillers/ssz/test_basic_types.py::test_uint64_vector4_typical[ssz_test]
// typeName: SampleUint64Vector4

test "vectors.test_uint64_vector4_typical" {
    const allocator = testing.allocator;
    const value: [4]u64 = [_]u64{ 1, 4294967296, 9223372036854775808, 18446744073709551615 };

    const expected_serialized_hex = "010000000000000000000000010000000000000000000080ffffffffffffffff";
    ...
    const expected_root_hex = "010000000000000000000000010000000000000000000080ffffffffffffffff";
    ...
    const decoded = try ssz.deserialize([4]u64, &reader);
