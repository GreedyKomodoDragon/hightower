...
// tests/fillers/ssz/test_basic_types.py::test_uint16_vector3_zero[ssz_test]
// typeName: SampleUint16Vector3

test "vectors.test_uint16_vector3_zero" {
    const allocator = testing.allocator;
    const value: [3]u16 = [_]u16{ 0, 0, 0 };

    const expected_serialized_hex = "000000000000";
