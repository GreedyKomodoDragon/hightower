...
// tests/fillers/ssz/test_basic_types.py::test_bytes4_typical[ssz_test]
// typeName: Bytes4

test "vectors.test_bytes4_typical" {
    const allocator = testing.allocator;
    var value: [4]u8 = undefined;
    _ = try std.fmt.hexToBytes(&value, "deadbeef");

    const expected_serialized_hex = "deadbeef";
    ...
    const expected_root_hex = "deadbeef00000000000000000000000000000000000000000000000000000000";
    ...
    const decoded = try ssz.deserialize([4]u8, &reader);
