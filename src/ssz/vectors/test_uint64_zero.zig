...
// tests/fillers/ssz/test_basic_types.py::test_uint64_zero[ssz_test]
// typeName: Uint64

test "vectors.test_uint64_zero" {
    const allocator = testing.allocator;
    const value: u64 = @as(u64, 0);

    const expected_serialized_hex = "0000000000000000";
