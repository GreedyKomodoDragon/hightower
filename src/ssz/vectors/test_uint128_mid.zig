...
// tests/fillers/ssz/test_basic_types.py::test_uint128_mid[ssz_test]
// typeName: Uint128

test "vectors.test_uint128_mid" {
    const allocator = testing.allocator;
    const value: u128 = @as(u128, 170141183460469231731687303715884105728);

    const expected_serialized_hex = "00000000000000000000000000000080";
    ...
    const expected_root_hex = "0000000000000000000000000000008000000000000000000000000000000000";
    ...
    const decoded = try ssz.deserialize(u128, &reader);
