...
// tests/fillers/ssz/test_basic_types.py::test_bytes4_zero[ssz_test]
// typeName: Bytes4

test "vectors.test_bytes4_zero" {
    const allocator = testing.allocator;
    var value: [4]u8 = undefined;
    _ = try std.fmt.hexToBytes(&value, "00000000");

    const expected_serialized_hex = "00000000";
