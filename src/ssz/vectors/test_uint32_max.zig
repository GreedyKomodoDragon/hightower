...
// tests/fillers/ssz/test_basic_types.py::test_uint32_max[ssz_test]
// typeName: Uint32

test "vectors.test_uint32_max" {
    const allocator = testing.allocator;
    const value: u32 = @as(u32, 4294967295);

    const expected_serialized_hex = "ffffffff";
    ...
    const expected_root_hex = "ffffffff00000000000000000000000000000000000000000000000000000000";
