...
// tests/fillers/ssz/test_basic_types.py::test_uint64_mid[ssz_test]
// typeName: Uint64

test "vectors.test_uint64_mid" {
    const allocator = testing.allocator;
    const value: u64 = @as(u64, 9223372036854775808);

    const expected_serialized_hex = "0000000000000080";
    ...
    const expected_root_hex = "0000000000000080000000000000000000000000000000000000000000000000";
