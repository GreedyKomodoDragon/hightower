...
// tests/fillers/ssz/test_basic_types.py::test_bytes32_typical[ssz_test]
// typeName: Bytes32

test "vectors.test_bytes32_typical" {
    const allocator = testing.allocator;
    var value: [32]u8 = undefined;
    _ = try std.fmt.hexToBytes(&value, "abababababababababababababababababababababababababababababababab");

    const expected_serialized_hex = "abababababababababababababababababababababababababababababababab";
    ...
    const expected_root_hex = "abababababababababababababababababababababababababababababababab";
