...
// tests/fillers/ssz/test_basic_types.py::test_uint128_max[ssz_test]
// typeName: Uint128

test "vectors.test_uint128_max" {
    const allocator = testing.allocator;
    const value: u128 = @as(u128, 340282366920938463463374607431768211455);

    const expected_serialized_hex = "ffffffffffffffffffffffffffffffff";
    ...
    const expected_root_hex = "ffffffffffffffffffffffffffffffff00000000000000000000000000000000";
