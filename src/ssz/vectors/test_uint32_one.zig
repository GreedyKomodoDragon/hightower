...
// tests/fillers/ssz/test_basic_types.py::test_uint32_one[ssz_test]
// typeName: Uint32

test "vectors.test_uint32_one" {
    const allocator = testing.allocator;
    const value: u32 = @as(u32, 1);

    const expected_serialized_hex = "01000000";
