...
// tests/fillers/ssz/test_basic_types.py::test_uint16_zero[ssz_test]
// typeName: Uint16

test "vectors.test_uint16_zero" {
    const allocator = testing.allocator;
    const value: u16 = @as(u16, 0);

    const expected_serialized_hex = "0000";
