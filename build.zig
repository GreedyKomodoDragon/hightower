...
pub fn build(b: *std.Build) void {
    ...
    const mod = b.addModule("hightower", .{
    ...
    const exe = b.addExecutable(.{
        ...
        .root_module = b.createModule(.{
            ...
            // root module.
            .imports = &.{
                // Here "hightower" is the name you will use in your source code to
                // import this module (e.g. `@import("hightower")`). The name is
                // repeated because you are allowed to rename your imports, which
                // can be extremely useful in case of collisions (which can happen
                // importing modules from different packages).
                .{ .name = "hightower", .module = mod },
            },
        }),
    });
    ...
    const rlp_tests = b.addTest(.{
        .root_module = b.createModule(.{
            .root_source_file = b.path("src/rlp/tests.zig"),
            .target = target,
            .optimize = optimize,
        }),
    });
    ...
    const run_tests = b.addRunArtifact(rlp_tests);
    const run_tests_ssz = b.addRunArtifact(ssz_tests);
    const run_tests_merkle = b.addRunArtifact(merkle_tests);
    ...
    test_step.dependOn(&run_tests_ssz.step);
    test_step.dependOn(&run_tests_merkle.step);
